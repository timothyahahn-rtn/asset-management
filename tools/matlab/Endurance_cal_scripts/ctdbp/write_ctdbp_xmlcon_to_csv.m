function write_ctdbp_xmlcon_to_csv(xmlfilename)
%.. desiderio 01-apr-2017
%
%.. reads in the SBE xmlconfile information and writes out the
%.. calcoeffs into csv files for uploading to the appropriate
...
%.. program reads in the coeffs from the xmlcon file as ascii and
%.. writes them out as ascii; no sigfig problem.
%
%.. FUNCTION CALLS:
%.. [con] = rad_read_ctdbp_xmlcon(xmlfilename)
...
caldate_provenance = ['date in filename comes from latest ' ...
       'sensor caldate within factory xmlcon file'];
